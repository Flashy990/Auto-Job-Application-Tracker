...
export default function Home() {
  ...
  <div>
    <header className="flex flex-row items-center mt-3 border-b-1 pb-3">
      <h1 style={{WebkitTextStroke: `1px black`, textShadow:`2px 2px 2px gray`}} className="font-akaya-kanadaka text-3xl sm:text-5xl md:text-6xl ml-4 text-[#BAD8C6]">JAT</h1>
      {/* unsolved: header layout design consistency */}
      <h1 className={`text-xl sm:text-4xl md:text-5xl font-allerta-stencil flex-grow text-center self-center ${authUser ? 'pr-[125.64px]' : ''}`}>Job Application Tracker</h1>
      {authUser ?   
        ...
        (<div className="flex flex-col sm:flex-row gap-1 sm:gap-6 self-end mr-1 sm:mr-4 text-[10px] sm:text-[13px] md:text-[16px]">
